  ...
  return (
    <Popover className="relative">
      {({ open }) => (
        <>
          <Popover.Button
            className="inline-flex items-center rounded-full p-3 text-sm font-medium shadow-sm bg-yellow-200 hover:bg-yellow-200 text-slate-900 transition-colors duration-150 ease-in-out"
          >
                      ...
                      <button
                        ...
                        className={clsx(
                          ...
                          value === preferredTheme && preferredTheme === "light"
                            ? "bg-yellow-100 dark:bg-yellow-90 dark:text-white"
                          ...
                          : value === preferredTheme && preferredTheme === "system"
                            ? "bg-blue-100 dark:bg-indigo-800 dark:text-white"
                          : "bg-transparent"
                        )}
                        onClick={() => {
